...
const Header = () => {
  ...
  return (
    <header className="fixed w-full h-[80px] z-50 top-0 left-0 right-0 transition-color duration-300 bg-neutral-100 dark:bg-indigo-950 shadow-[0_-60px_30px_100px_rgba(245,245,245,1)] dark:shadow-[0_-60px_30px_100px_rgba(30,27,75,1)] ">
